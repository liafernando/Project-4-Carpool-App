...
import 'package:first_app/models/user_ride_request_information.dart';
import 'package:first_app/widgets/fare_amount_collection_dialog.dart';
...
class _NewTripScreenState extends State<NewTripScreen> {
  ...
  // Step 1: When the driver accepts the user ride request
// Set the originLatLng to the driver's current location
// Set the destinationLatLng to the user's pickup location


  // Step 2: Driver has already picked up the user in their car
// Set the originLatLng from the user's pickup location to the driver's current location
// Set the destinationLatLng to the user's drop-off location
