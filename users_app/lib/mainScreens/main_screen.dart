...
class _MainScreenState extends State<MainScreen> {
  ...
  searchNearestOnlineDrivers() async {
    ...
    var response = Navigator.push(context, MaterialPageRoute(builder: (c) =>
  ...
  {
    //setting rideRequestId to newRideStatus in
    ...
    //automating the push notification
  }
                            ...
                            children: [
                              ...
                              Text(
                                Provider.of<AppInfo>(context)
                                    ...
                                    ? Provider.of<AppInfo>(context)
                                        .userPickUpLocation!
                                        .locationName! // checks the location if entered and if not gets the current location.
